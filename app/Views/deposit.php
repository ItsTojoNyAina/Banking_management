                ...
                <div class="row justify-content-md-center">
                    <div class="col-6">
                        ...
                        <form action="/deposit/process" method="post">
                            <div class="mb-3">
                                <label for="InputForDeposit" class="form-label">Deposit Amount (Ariary)</label>
                                <input type="number" name="deposit_amount" class="form-control" id="InputForDeposit" value="<?= set_value('deposit_amount') ?>" required>
                            </div>
