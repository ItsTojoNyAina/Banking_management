            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-6">
                        ...
                        <?php endif;?>
                        <form action="/loan/process" method="post">
                            <div class="mb-3">
                                <label for="InputForLoan" class="form-label">Loan Amount (Ariary)</label>
                                <input type="number" name="amount" class="form-control" id="InputForLoan" value="<?= set_value('amount') ?>" required>
                            </div>
